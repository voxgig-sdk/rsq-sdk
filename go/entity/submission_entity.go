...
func NewSubmissionEntity(client *core.RsqSDK, entopts map[string]any) *SubmissionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubmissionEntity) GetName() string { return e.name }
...
func (e *SubmissionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SubmissionEntity) Deleted() bool {
	return e.deleted
}


func (e *SubmissionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSubmissionEntity(e.client, opts)
}

func (e *SubmissionEntity) Data(args ...any) any {
...
func (e *SubmissionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Submission; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SubmissionEntity) DataTyped(data ...Submission) Submission {
	if len(data) > 0 {
		return typedFrom[Submission](e.Data(asMap(data[0])))
	}
	return typedFrom[Submission](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Submission (all fields
// optional at the wire level).
func (e *SubmissionEntity) MatchTyped(match ...Submission) Submission {
	if len(match) > 0 {
		return typedFrom[Submission](e.Match(asMap(match[0])))
	}
	return typedFrom[Submission](e.Match())
}
...
func (e *SubmissionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SubmissionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SubmissionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SubmissionListMatch and returns []Submission. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SubmissionEntity) ListTyped(reqmatch SubmissionListMatch, ctrl map[string]any) ([]Submission, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Submission](res), nil
}



func (e *SubmissionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SubmissionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SubmissionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SubmissionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
