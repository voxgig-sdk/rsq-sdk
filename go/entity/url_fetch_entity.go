...
func NewUrlFetchEntity(client *core.RsqSDK, entopts map[string]any) *UrlFetchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UrlFetchEntity) GetName() string { return e.name }
...
func (e *UrlFetchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UrlFetchEntity) Deleted() bool {
	return e.deleted
}


func (e *UrlFetchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUrlFetchEntity(e.client, opts)
}

func (e *UrlFetchEntity) Data(args ...any) any {
...
func (e *UrlFetchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UrlFetch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UrlFetchEntity) DataTyped(data ...UrlFetch) UrlFetch {
	if len(data) > 0 {
		return typedFrom[UrlFetch](e.Data(asMap(data[0])))
	}
	return typedFrom[UrlFetch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UrlFetch (all fields
// optional at the wire level).
func (e *UrlFetchEntity) MatchTyped(match ...UrlFetch) UrlFetch {
	if len(match) > 0 {
		return typedFrom[UrlFetch](e.Match(asMap(match[0])))
	}
	return typedFrom[UrlFetch](e.Match())
}
...
func (e *UrlFetchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UrlFetchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *UrlFetchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UrlFetchListMatch and returns []UrlFetch. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *UrlFetchEntity) ListTyped(reqmatch UrlFetchListMatch, ctrl map[string]any) ([]UrlFetch, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[UrlFetch](res), nil
}



func (e *UrlFetchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UrlFetchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UrlFetchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UrlFetchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
