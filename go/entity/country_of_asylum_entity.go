...
type CountryOfAsylumEntity struct {
	name    string
	client  *core.RsqSDK
...
func NewCountryOfAsylumEntity(client *core.RsqSDK, entopts map[string]any) *CountryOfAsylumEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CountryOfAsylumEntity) GetName() string { return e.name }
...
func (e *CountryOfAsylumEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CountryOfAsylumEntity) Deleted() bool {
	return e.deleted
}


func (e *CountryOfAsylumEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCountryOfAsylumEntity(e.client, opts)
}

func (e *CountryOfAsylumEntity) Data(args ...any) any {
...
func (e *CountryOfAsylumEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CountryOfAsylum; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CountryOfAsylumEntity) DataTyped(data ...CountryOfAsylum) CountryOfAsylum {
	if len(data) > 0 {
		return typedFrom[CountryOfAsylum](e.Data(asMap(data[0])))
	}
	return typedFrom[CountryOfAsylum](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CountryOfAsylum (all fields
// optional at the wire level).
func (e *CountryOfAsylumEntity) MatchTyped(match ...CountryOfAsylum) CountryOfAsylum {
	if len(match) > 0 {
		return typedFrom[CountryOfAsylum](e.Match(asMap(match[0])))
	}
	return typedFrom[CountryOfAsylum](e.Match())
}
...
func (e *CountryOfAsylumEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CountryOfAsylumEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CountryOfAsylumEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CountryOfAsylumListMatch and returns []CountryOfAsylum. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CountryOfAsylumEntity) ListTyped(reqmatch CountryOfAsylumListMatch, ctrl map[string]any) ([]CountryOfAsylum, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CountryOfAsylum](res), nil
}



func (e *CountryOfAsylumEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CountryOfAsylumEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CountryOfAsylumEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CountryOfAsylumEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
