...
func NewDemographicEntity(client *core.RsqSDK, entopts map[string]any) *DemographicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DemographicEntity) GetName() string { return e.name }
...
func (e *DemographicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DemographicEntity) Deleted() bool {
	return e.deleted
}


func (e *DemographicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDemographicEntity(e.client, opts)
}

func (e *DemographicEntity) Data(args ...any) any {
...
func (e *DemographicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Demographic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DemographicEntity) DataTyped(data ...Demographic) Demographic {
	if len(data) > 0 {
		return typedFrom[Demographic](e.Data(asMap(data[0])))
	}
	return typedFrom[Demographic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Demographic (all fields
// optional at the wire level).
func (e *DemographicEntity) MatchTyped(match ...Demographic) Demographic {
	if len(match) > 0 {
		return typedFrom[Demographic](e.Match(asMap(match[0])))
	}
	return typedFrom[Demographic](e.Match())
}
...
func (e *DemographicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DemographicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DemographicEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DemographicListMatch and returns []Demographic. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DemographicEntity) ListTyped(reqmatch DemographicListMatch, ctrl map[string]any) ([]Demographic, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Demographic](res), nil
}



func (e *DemographicEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DemographicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DemographicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DemographicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
