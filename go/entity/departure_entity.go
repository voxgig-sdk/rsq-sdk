...
func NewDepartureEntity(client *core.RsqSDK, entopts map[string]any) *DepartureEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DepartureEntity) GetName() string { return e.name }
...
func (e *DepartureEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DepartureEntity) Deleted() bool {
	return e.deleted
}


func (e *DepartureEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDepartureEntity(e.client, opts)
}

func (e *DepartureEntity) Data(args ...any) any {
...
func (e *DepartureEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Departure; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DepartureEntity) DataTyped(data ...Departure) Departure {
	if len(data) > 0 {
		return typedFrom[Departure](e.Data(asMap(data[0])))
	}
	return typedFrom[Departure](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Departure (all fields
// optional at the wire level).
func (e *DepartureEntity) MatchTyped(match ...Departure) Departure {
	if len(match) > 0 {
		return typedFrom[Departure](e.Match(asMap(match[0])))
	}
	return typedFrom[Departure](e.Match())
}
...
func (e *DepartureEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DepartureEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DepartureEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DepartureListMatch and returns []Departure. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DepartureEntity) ListTyped(reqmatch DepartureListMatch, ctrl map[string]any) ([]Departure, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Departure](res), nil
}



func (e *DepartureEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DepartureEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DepartureEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DepartureEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
