...
func NewHelperEntity(client *core.RsqSDK, entopts map[string]any) *HelperEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HelperEntity) GetName() string { return e.name }
...
func (e *HelperEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HelperEntity) Deleted() bool {
	return e.deleted
}


func (e *HelperEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHelperEntity(e.client, opts)
}

func (e *HelperEntity) Data(args ...any) any {
...
func (e *HelperEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *HelperEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HelperEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *HelperEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HelperEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HelperEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HelperEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
