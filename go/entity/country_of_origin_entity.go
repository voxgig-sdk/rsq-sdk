...
type CountryOfOriginEntity struct {
	name    string
	client  *core.RsqSDK
...
func NewCountryOfOriginEntity(client *core.RsqSDK, entopts map[string]any) *CountryOfOriginEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CountryOfOriginEntity) GetName() string { return e.name }
...
func (e *CountryOfOriginEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CountryOfOriginEntity) Deleted() bool {
	return e.deleted
}


func (e *CountryOfOriginEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCountryOfOriginEntity(e.client, opts)
}

func (e *CountryOfOriginEntity) Data(args ...any) any {
...
func (e *CountryOfOriginEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CountryOfOrigin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CountryOfOriginEntity) DataTyped(data ...CountryOfOrigin) CountryOfOrigin {
	if len(data) > 0 {
		return typedFrom[CountryOfOrigin](e.Data(asMap(data[0])))
	}
	return typedFrom[CountryOfOrigin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CountryOfOrigin (all fields
// optional at the wire level).
func (e *CountryOfOriginEntity) MatchTyped(match ...CountryOfOrigin) CountryOfOrigin {
	if len(match) > 0 {
		return typedFrom[CountryOfOrigin](e.Match(asMap(match[0])))
	}
	return typedFrom[CountryOfOrigin](e.Match())
}
...
func (e *CountryOfOriginEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CountryOfOriginEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CountryOfOriginEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CountryOfOriginListMatch and returns []CountryOfOrigin. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CountryOfOriginEntity) ListTyped(reqmatch CountryOfOriginListMatch, ctrl map[string]any) ([]CountryOfOrigin, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CountryOfOrigin](res), nil
}



func (e *CountryOfOriginEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CountryOfOriginEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CountryOfOriginEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CountryOfOriginEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
