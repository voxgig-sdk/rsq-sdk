...
func TestCategoryEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set RSQ_TEST_CATEGORY_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func categoryBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("RSQ_TEST_CATEGORY_ENTID")
	...
	idmapResolved := core.ToMapAny(env["RSQ_TEST_CATEGORY_ENTID"])
