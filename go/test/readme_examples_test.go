...
const testSeed = `map[string]any{"entity": map[string]any{"category": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country_of_asylum": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country_of_origin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country_of_resettlement": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "demographic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "departure": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "helper": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "region": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "submission": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "url_fetch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "year": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
