...
The Golang SDK for the Rsq API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/rsq-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/rsq-sdk=../path/to/github.com/voxgig-sdk/rsq-sdk
```
...
The root package (`github.com/voxgig-sdk/rsq-sdk`) re-exports everything needed
