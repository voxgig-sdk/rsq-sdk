...
(0, node_test_1.describe)('DepartureDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-departure', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-departure', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['RSQ_TEST_DEPARTURE_ENTID'];
...
//# sourceMappingURL=DepartureDirect.test.js.map