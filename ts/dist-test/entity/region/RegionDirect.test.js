...
(0, node_test_1.describe)('RegionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-region', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-region', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['RSQ_TEST_REGION_ENTID'];
...
//# sourceMappingURL=RegionDirect.test.js.map