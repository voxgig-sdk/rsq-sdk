...
(0, node_test_1.describe)('CountryOfOriginDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-country_of_origin', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-country_of_origin', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.RSQ_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RsqSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['RSQ_TEST_COUNTRY_OF_ORIGIN_ENTID'];
...
//# sourceMappingURL=CountryOfOriginDirect.test.js.map