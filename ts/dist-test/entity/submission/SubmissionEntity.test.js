...
(0, node_test_1.describe)('SubmissionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let submission_ref01_data = Object.values(setup.data.existing.submission)[0];
        // LIST
        const submission_ref01_ent = client.Submission();
        const submission_ref01_match = {};
        const submission_ref01_list = (await submission_ref01_ent.list(submission_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/submission/SubmissionTestData.json');
    ...
    let idmap = transform(['submission01', 'submission02', 'submission03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SubmissionEntity.test.js.map