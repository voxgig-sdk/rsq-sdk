...
(0, node_test_1.describe)('CountryOfResettlementDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-country_of_resettlement', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-country_of_resettlement', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['RSQ_TEST_COUNTRY_OF_RESETTLEMENT_ENTID'];
...
//# sourceMappingURL=CountryOfResettlementDirect.test.js.map