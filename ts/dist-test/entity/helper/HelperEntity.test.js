...
(0, node_test_1.describe)('HelperEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'helper.' + op, live))
                return;
        }
        ...
        let helper_ref01_data = Object.values(setup.data.existing.helper)[0];
        // LOAD
        const helper_ref01_ent = client.Helper();
        const helper_ref01_match_dt0 = {};
        const helper_ref01_data_dt0 = (await helper_ref01_ent.load(helper_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != helper_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/helper/HelperTestData.json');
    ...
    let idmap = transform(['helper01', 'helper02', 'helper03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['RSQ_TEST_HELPER_ENTID'];
...
//# sourceMappingURL=HelperEntity.test.js.map