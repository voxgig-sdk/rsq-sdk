...
class SubmissionEntity extends RsqEntityBase_1.RsqEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'submission';
        this.name_ = 'submission';
        this.Name = 'Submission';
    }
    make() {
        return new SubmissionEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Submission[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=SubmissionEntity.js.map