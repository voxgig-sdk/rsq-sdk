...
class DepartureEntity
  ...
  def make
    opts = @_entopts.dup
    DepartureEntity.new(@_client, opts)
  end
  ...
  # @return [Departure, Hash] the current Departure data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Departure fields)
  def match_get
  ...
  #
  # @param reqmatch [DepartureListMatch, Hash, nil] match filter (any subset of
  #   Departure fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Departure>, Array] the matching Departure items; raises RsqError on failure
