...
class CountryOfOriginEntity
  ...
  def make
    opts = @_entopts.dup
    CountryOfOriginEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CountryOfOriginListMatch, Hash, nil] match filter (any subset of
  #   CountryOfOrigin fields); defaults to nil, treated as an empty match that lists all.
