...
class DemographicEntity
  ...
  def make
    opts = @_entopts.dup
    DemographicEntity.new(@_client, opts)
  end
  ...
  # @return [Demographic, Hash] the current Demographic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Demographic fields)
  def match_get
  ...
  #
  # @param reqmatch [DemographicListMatch, Hash, nil] match filter (any subset of
  #   Demographic fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Demographic>, Array] the matching Demographic items; raises RsqError on failure
