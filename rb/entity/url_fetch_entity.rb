...
class UrlFetchEntity
  ...
  def make
    opts = @_entopts.dup
    UrlFetchEntity.new(@_client, opts)
  end
  ...
  # @return [UrlFetch, Hash] the current UrlFetch data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UrlFetch fields)
  def match_get
  ...
  #
  # @param reqmatch [UrlFetchListMatch, Hash, nil] match filter (any subset of
  #   UrlFetch fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<UrlFetch>, Array] the matching UrlFetch items; raises RsqError on failure
