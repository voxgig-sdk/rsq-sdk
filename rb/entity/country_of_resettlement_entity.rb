...
class CountryOfResettlementEntity
  ...
  def make
    opts = @_entopts.dup
    CountryOfResettlementEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CountryOfResettlementListMatch, Hash, nil] match filter (any subset of
  #   CountryOfResettlement fields); defaults to nil, treated as an empty match that lists all.
