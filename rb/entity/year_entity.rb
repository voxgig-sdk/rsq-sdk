...
class YearEntity
  ...
  # List Year items matching the given filter.
  #
  # @param reqmatch [YearListMatch, Hash, nil] match filter (any subset of
  #   Year fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Year>, Array] the matching Year items; raises RsqError on failure
