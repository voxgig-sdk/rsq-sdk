...
module RsqTestRunner
  ...
  def self.env_override(m)
    live = getenv("RSQ_TEST_LIVE")
    override = getenv("RSQ_TEST_OVERRIDE")
    ...
    explain = getenv("RSQ_TEST_EXPLAIN")
    m["RSQ_TEST_EXPLAIN"] = explain if explain && !explain.empty?
