...
class CountryOfResettlementEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CountryOfResettlementEntity(self._client, opts)
    ...
    def data_get(self) -> CountryOfResettlement:
    ...
    def match_get(self) -> CountryOfResettlement:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CountryOfResettlement]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CountryOfResettlement().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
