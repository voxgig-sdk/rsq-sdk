...
class CountryOfAsylumEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CountryOfAsylumEntity(self._client, opts)
    ...
    def data_get(self) -> CountryOfAsylum:
    ...
    def match_get(self) -> CountryOfAsylum:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CountryOfAsylum]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CountryOfAsylum().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
