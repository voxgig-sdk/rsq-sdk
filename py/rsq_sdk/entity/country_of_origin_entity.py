...
from rsq_sdk.rsq_types import (
    CountryOfOrigin,
    CountryOfOriginListMatch,
)


class CountryOfOriginEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CountryOfOriginEntity(self._client, opts)
    ...
    def data_get(self) -> CountryOfOrigin:
    ...
    def match_get(self) -> CountryOfOrigin:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CountryOfOrigin]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CountryOfOrigin().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
