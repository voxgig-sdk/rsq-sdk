...
from rsq_sdk.utility import register

# Load features
from rsq_sdk.feature.base_feature import RsqBaseFeature
from rsq_sdk.features import _has_feature, _make_feature
...
class RsqSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "RsqSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RsqSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Helper(self, data=None) -> "HelperEntity":
        ...
        from rsq_sdk.entity.helper_entity import HelperEntity
    ...
    def Region(self, data=None) -> "RegionEntity":
        ...
        from rsq_sdk.entity.region_entity import RegionEntity
    ...
    def Submission(self, data=None) -> "SubmissionEntity":
        ...
        from rsq_sdk.entity.submission_entity import SubmissionEntity
