...
class TestCountryOfAsylumEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.CountryOfAsylum(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.CountryOfAsylum(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        country_of_asylum_ref01_list_result = country_of_asylum_ref01_ent.list(country_of_asylum_ref01_match, None)
