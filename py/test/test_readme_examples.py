# Rsq SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RsqSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RsqSDK(...) and RsqSDK.test(...) become
#      RsqSDK.test({"entity": {...}}) seeding one mock record (id "test01")
