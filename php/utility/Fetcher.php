...
class RsqFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RsqSDK/1.0)';
    ...
    public static function call(RsqContext $ctx, string $fullurl, array $fetchdef): array
    {
