...
class YearEntity
{
     ...
     *
     * @param YearListMatch|array|null $reqmatch Match filter (any subset
     *   of Year fields) as an assoc-array; YearListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Year[]|array A list of Year items as assoc-arrays at
