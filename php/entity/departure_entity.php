...
class DepartureEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DepartureEntity($this->_client, $opts);
    }

    /**
     * @param Departure|array $args Departure data (assoc-array) to store.
     */
    ...
    /**
     * @return Departure|array The current Departure data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Departure fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Departure fields).
     */
    ...
    /**
     * List Departure items matching the given filter.
     *
     * @param DepartureListMatch|array|null $reqmatch Match filter (any subset
     *   of Departure fields) as an assoc-array; DepartureListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Departure[]|array A list of Departure items as assoc-arrays at
