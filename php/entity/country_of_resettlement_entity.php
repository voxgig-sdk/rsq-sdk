...
class CountryOfResettlementEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "country_of_resettlement";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CountryOfResettlementEntity($this->_client, $opts);
    }

    /**
     * @param CountryOfResettlement|array $args CountryOfResettlement data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = RsqHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return CountryOfResettlement|array The current CountryOfResettlement data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CountryOfResettlement fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = RsqHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of CountryOfResettlement fields).
     */
     ...
     *
     * @param CountryOfResettlementListMatch|array|null $reqmatch Match filter (any subset
     *   of CountryOfResettlement fields) as an assoc-array; CountryOfResettlementListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CountryOfResettlement[]|array A list of CountryOfResettlement items as assoc-arrays at
