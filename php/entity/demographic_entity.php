...
class DemographicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DemographicEntity($this->_client, $opts);
    }

    /**
     * @param Demographic|array $args Demographic data (assoc-array) to store.
     */
    ...
    /**
     * @return Demographic|array The current Demographic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Demographic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Demographic fields).
     */
    ...
    /**
     * List Demographic items matching the given filter.
     *
     * @param DemographicListMatch|array|null $reqmatch Match filter (any subset
     *   of Demographic fields) as an assoc-array; DemographicListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Demographic[]|array A list of Demographic items as assoc-arrays at
