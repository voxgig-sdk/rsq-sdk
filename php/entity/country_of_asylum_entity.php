...
// Rsq SDK CountryOfAsylum entity
...
class CountryOfAsylumEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CountryOfAsylumEntity($this->_client, $opts);
    }

    /**
     * @param CountryOfAsylum|array $args CountryOfAsylum data (assoc-array) to store.
     */
    ...
    /**
     * @return CountryOfAsylum|array The current CountryOfAsylum data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CountryOfAsylum fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CountryOfAsylum fields).
     */
    ...
    /**
     * List CountryOfAsylum items matching the given filter.
     *
     * @param CountryOfAsylumListMatch|array|null $reqmatch Match filter (any subset
     *   of CountryOfAsylum fields) as an assoc-array; CountryOfAsylumListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CountryOfAsylum[]|array A list of CountryOfAsylum items as assoc-arrays at
