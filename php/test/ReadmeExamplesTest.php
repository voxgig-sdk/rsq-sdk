...
// Rsq SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RsqSDK::test)
...
{
    private const SDK_CLASS = 'RsqSDK';
    ...
    private const SDK_BASE = 'rsq_sdk';
