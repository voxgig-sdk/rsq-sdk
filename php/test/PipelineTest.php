...
{
    private static function utility(): RsqUtility
    {
        return new RsqUtility();
    }
    ...
    private static function ctx(array $over = []): RsqContext
    {
        ...
        $ctx->op = new RsqOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RsqError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RsqOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RsqMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RsqOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RsqMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RsqOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RsqMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RsqSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RsqMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RsqResponse([]),
            'result' => new RsqResult([]),
        ]);
        [, $err] = RsqMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RsqSpec(['step' => 's']),
            'response' => new RsqResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RsqResult([]),
        ]);
        [, $err] = RsqMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RsqSpec(['step' => 's']),
            'response' => new RsqResponse(self::resp(200, ['v' => 1])),
            'result' => new RsqResult([]),
        ]);
        [, $err] = RsqMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RsqSpec(['step' => 's']),
            'response' => new RsqResponse(self::resp(200, ['v' => 2])),
            'result' => new RsqResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RsqMakeResponse::call($ctx);
    ...
    {
        $preset = new RsqResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RsqSpec([]),
            'response' => new RsqResponse([]),
            'result' => new RsqResult([]),
        ...
        [$got, $err] = RsqMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RsqResult([])]);
        [, $err] = RsqMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RsqSpec([]), 'result' => null]);
        [, $err] = RsqMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RsqSpec(['step' => 's']),
            'result' => new RsqResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RsqOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RsqMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RsqSpec(['step' => 's']),
            'result' => new RsqResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RsqOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RsqMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RsqResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RsqSpec([]),
            'result' => new RsqResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RsqMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $utility = self::utility();
        $boom = new RsqError('boom', 'boom');
        $utility->fetcher = function (RsqContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RsqSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RsqMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RsqContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RsqMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RsqResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RsqContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RsqSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RsqMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RsqResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RsqSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RsqMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RsqMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RsqResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RsqDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RsqResult(['ok' => false])]);
        $this->expectException(RsqError::class);
        RsqDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RsqResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RsqMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RsqBaseFeature();
        $b = new RsqBaseFeature();
        RsqFeatureAdd::call($ctx, $a);
        RsqFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RsqBaseFeature
    {
        $f = new RsqBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    private static function auth_ctx(array $options, ?array $headers): RsqContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RsqSpec(['headers' => $headers]),
        ]);
    }
    ...
    {
        $ctx = self::ctx([
            'response' => new RsqResponse(['headers' => null]),
            'result' => new RsqResult([]),
        ]);
        RsqResultHeaders::call($ctx);
