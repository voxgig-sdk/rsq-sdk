...
class SubmissionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set RSQ_TEST_SUBMISSION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $submission_ref01_data = null;
        if (count($submission_ref01_data_raw) > 0) {
...
function submission_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("RSQ_TEST_SUBMISSION_ENTID");
