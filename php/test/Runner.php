...
class RsqTestRunner
{
    ...
    {
        $live = self::getenv('RSQ_TEST_LIVE');
        $override = self::getenv('RSQ_TEST_OVERRIDE');
        ...
        $explain = self::getenv('RSQ_TEST_EXPLAIN');
...
class_alias('RsqTestRunner', 'Runner');
class_alias('RsqHelpers', 'Helpers');
