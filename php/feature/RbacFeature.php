...
class RsqRbacFeature extends RsqBaseFeature
{
    ...
    private function _required(RsqContext $ctx): ?string
    {
    ...
    private function _reject(RsqContext $ctx, string $required): void
    {
    ...
    private function _track(RsqContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
