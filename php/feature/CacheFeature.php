...
class RsqCacheFeature extends RsqBaseFeature
{
    ...
    private function _through(RsqContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
