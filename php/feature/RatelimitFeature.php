...
class RsqRatelimitFeature extends RsqBaseFeature
{
    ...
    private function _acquire(RsqContext $ctx): void
    {
    ...
    private function _track(RsqContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
