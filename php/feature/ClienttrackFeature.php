...
class RsqClienttrackFeature extends RsqBaseFeature
{
    ...
    public function PostConstruct(RsqContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Rsq-SDK';
