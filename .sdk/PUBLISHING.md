...
|---|---|---|
| `ts/` | @voxgig-sdk/rsq-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/rsq-sdk \
      --repository voxgig-sdk/rsq-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/rsq-sdk` shows it, and
`npm trust revoke @voxgig-sdk/rsq-sdk --id=<id>` removes it.
