...
class RsqTimeoutFeature extends RsqBaseFeature
{
    ...
    private function _with_timeout(RsqContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RsqContext $_ctx, float $ms): void
    {
        $client = $this->client;
