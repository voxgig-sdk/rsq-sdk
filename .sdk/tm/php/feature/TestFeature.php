...
// Rsq SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RsqTestFeature extends RsqBaseFeature
{
    ...
    public function init(RsqContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RsqContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RsqContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RsqContext $ctx, $op, $args): array
    {
