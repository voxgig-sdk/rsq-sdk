...
class RsqStreamingFeature extends RsqBaseFeature
{
    ...
    private function _iterate(RsqResult $result): \Generator
    {
    ...
    private function _streamable(RsqContext $ctx): bool
    {
