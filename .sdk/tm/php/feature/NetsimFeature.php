...
class RsqNetsimFeature extends RsqBaseFeature
{
    ...
    private function _simulate(RsqContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RsqContext $ctx, array $applied): void
    {
        $client = $this->client;
