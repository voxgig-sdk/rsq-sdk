...
// Rsq SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RsqMakeRequest
{
    public static function call(RsqContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RsqResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RsqResponse($fetched);
        } else {
