...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/rsq` | `npm install @voxgig-sdk/rsq` |
| Python | `voxgig-sdk-rsq` | `pip install voxgig-sdk-rsq` |
| PHP | `voxgig-sdk/rsq` | `composer require voxgig-sdk/rsq` |
| Golang | `github.com/voxgig-sdk/rsq-sdk/go` | `go get github.com/voxgig-sdk/rsq-sdk/go` |
| Ruby | `voxgig-sdk-rsq` | `gem install voxgig-sdk-rsq` |
| Lua | `voxgig-sdk-rsq` | `luarocks install voxgig-sdk-rsq` |
