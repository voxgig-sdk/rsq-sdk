...
Full stack RESTful API for entity lists, single entity access, and complex query built requests.

Learn more about RSQ API at [unhcr.org](http://unhcr.org).
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/rsq-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/rsq-sdk/tags) |
| Python | `voxgig-sdk-rsq` | publish pending — [install from git tag](https://github.com/voxgig-sdk/rsq-sdk/tags) |
| PHP | `voxgig-sdk/rsq` | publish pending — [install from git tag](https://github.com/voxgig-sdk/rsq-sdk/tags) |
| Golang | `github.com/voxgig-sdk/rsq-sdk/go` | `go get github.com/voxgig-sdk/rsq-sdk/go@latest` |
| Ruby | `voxgig-sdk-rsq` | publish pending — [install from git tag](https://github.com/voxgig-sdk/rsq-sdk/tags) |
| Lua | `voxgig-sdk-rsq` | publish pending — [install from git tag](https://github.com/voxgig-sdk/rsq-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/rsq-sdk/go-cli` | `go install github.com/voxgig-sdk/rsq-sdk/go-cli/cmd/rsq@latest` |
| Go MCP server | `github.com/voxgig-sdk/rsq-sdk/go-mcp` | `go get github.com/voxgig-sdk/rsq-sdk/go-mcp@latest` |
...
$categorys = $client->Category()->list();
print_r(array_map(fn($item) => $item->data_get(), $categorys));
```
