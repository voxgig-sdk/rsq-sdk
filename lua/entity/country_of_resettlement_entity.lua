-- Rsq SDK CountryOfResettlement entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CountryOfResettlementEntity = {}
CountryOfResettlementEntity.__index = CountryOfResettlementEntity


function CountryOfResettlementEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CountryOfResettlementEntity)
  self._name = "country_of_resettlement"
  self._client = client
...
function CountryOfResettlementEntity:get_name()
  return self._name
end


function CountryOfResettlementEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CountryOfResettlementEntity.new(self._client, opts)
end
...
function CountryOfResettlementEntity:mark_deleted()
  self._deleted = true
end


function CountryOfResettlementEntity:deleted()
  return true == self._deleted
end


function CountryOfResettlementEntity:data_set(args)
  if args ~= nil then
...
function CountryOfResettlementEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CountryOfResettlementEntity:match_set(args)
  if args ~= nil then
...
function CountryOfResettlementEntity:match_get()
...
function CountryOfResettlementEntity:stream(action, args, callopts)
...
---@param reqmatch CountryOfResettlementListMatch
---@param ctrl? table
---@return CountryOfResettlement[]
---@return string? err
function CountryOfResettlementEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CountryOfResettlementEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CountryOfResettlementEntity
