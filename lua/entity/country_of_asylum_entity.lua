...
local CountryOfAsylumEntity = {}
CountryOfAsylumEntity.__index = CountryOfAsylumEntity


function CountryOfAsylumEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CountryOfAsylumEntity)
  self._name = "country_of_asylum"
  self._client = client
...
function CountryOfAsylumEntity:get_name()
  return self._name
end


function CountryOfAsylumEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CountryOfAsylumEntity.new(self._client, opts)
end
...
function CountryOfAsylumEntity:mark_deleted()
  self._deleted = true
end


function CountryOfAsylumEntity:deleted()
  return true == self._deleted
end


function CountryOfAsylumEntity:data_set(args)
  if args ~= nil then
...
function CountryOfAsylumEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CountryOfAsylumEntity:match_set(args)
  if args ~= nil then
...
function CountryOfAsylumEntity:match_get()
...
function CountryOfAsylumEntity:stream(action, args, callopts)
...
function CountryOfAsylumEntity:_run_op(ctx, post_done)
  local utility = self._utility
