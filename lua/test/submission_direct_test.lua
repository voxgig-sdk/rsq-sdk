...
describe("SubmissionDirect", function()
  it("should direct-list-submission", function()
    local setup = submission_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-submission", setup.live and "live" or "unit")
...
function submission_direct_setup(mockres)
