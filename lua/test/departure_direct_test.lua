...
describe("DepartureDirect", function()
  it("should direct-list-departure", function()
    local setup = departure_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-departure", setup.live and "live" or "unit")
...
function departure_direct_setup(mockres)
