...
describe("UrlFetchDirect", function()
  it("should direct-list-url_fetch", function()
    local setup = url_fetch_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-url_fetch", setup.live and "live" or "unit")
...
function url_fetch_direct_setup(mockres)
