...
describe("DemographicDirect", function()
  it("should direct-list-demographic", function()
    local setup = demographic_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-demographic", setup.live and "live" or "unit")
...
function demographic_direct_setup(mockres)
