...
describe("CountryOfOriginDirect", function()
  it("should direct-list-country_of_origin", function()
    local setup = country_of_origin_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-country_of_origin", setup.live and "live" or "unit")
...
function country_of_origin_direct_setup(mockres)
