...
describe("DepartureEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Departure(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Departure(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set RSQ_TEST_DEPARTURE_ENTID JSON to run live")
      return
    end
...
function departure_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("RSQ_TEST_DEPARTURE_ENTID")
