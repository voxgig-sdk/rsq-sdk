...
describe("YearDirect", function()
  it("should direct-list-year", function()
    local setup = year_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-year", setup.live and "live" or "unit")
...
function year_direct_setup(mockres)
