...
describe("HelperDirect", function()
  it("should direct-load-helper", function()
    local setup = helper_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-helper", setup.live and "live" or "unit")
...
function helper_direct_setup(mockres)
