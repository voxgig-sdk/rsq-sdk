...
describe("CountryOfAsylumDirect", function()
  it("should direct-list-country_of_asylum", function()
    local setup = country_of_asylum_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-country_of_asylum", setup.live and "live" or "unit")
...
function country_of_asylum_direct_setup(mockres)
